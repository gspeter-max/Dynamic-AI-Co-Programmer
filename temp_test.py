...
class make_embedding:
    ...
    def get_embedding_for_this_node(self,node, child_temp = None, parent_temp = None):
        ...
        for child in node.children:
            if not child.children:
                ...
                child_temp.append(transformed_by_linear_layer_output)
                ...
                try:
                    if node.type not in self.ignore_types:
                        ...
                        child_embedding_uisng_recursion = self.get_embedding_for_this_node(child,temp = [])  # after stack that become List() --> 2d
                        ...
                        a = parent_node_embedding + child_embedding_uisng_recursion
        ...
        return torch.mean(torch.stack(temp),dim = 0)
